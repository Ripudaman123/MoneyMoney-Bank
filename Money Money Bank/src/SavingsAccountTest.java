...
public class SavingsAccountTest {
	...
	public static void main(String[] args) {
		...
		SavingsAccount account1 = new SavingsAccount("Ram", 5000.0);
		SavingsAccount account2 = new SavingsAccount("Shyam");
		...
		System.out.println("Enter 1 if transfer is to be from Ram to Shyam or 2 for vice versa");
